...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 cagk C:/Users/Administrator/Desktop/modelHNN/mod/cagk.mod\n");
...
double alp ( _threadargsprotocomma_ double _lv , double _lc ) {
   double _lalp;
...
double bet ( _threadargsprotocomma_ double _lv , double _lc ) {
   double _lbet;
...
double exp1 ( _threadargsprotocomma_ double _lk , double _ld , double _lv ) {
   double _lexp1;
...
static int  rate ( _threadargsprotocomma_ double _lv , double _lc ) {
   double _la ;
